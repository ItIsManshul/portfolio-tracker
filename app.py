...
# --- TOP RIGHT REFRESH BUTTON (Floating-style layout) ---
    ...
    if st.button("🔄 Refresh", use_container_width=True):
        ...
        for h in st.session_state["holdings"]:
            ...
            try:
                ...
                st.warning(f"⚠️ Error updating {ticker}")
                updated_holdings.append(h)

        st.session_state["holdings"] = updated_holdings
...
# --- TABS ---
tab1, tab2, tab3, tab4 = st.tabs(["📄 Overview", "📊 Analytics", "Company Specifics", "💰 Dividends"])
